...
class ElizaTest(unittest.TestCase):
    ...
    def test_syn_1(self):
        el = eliza.Eliza()
        el.load('F:\CPEY.4\TERM2\NLP\HW4\eliza-master\doctor.txt')
    ...
    def test_syn_3(self):
        el = eliza.Eliza()
        el.load('F:\CPEY.4\TERM2\NLP\HW4\eliza-master\edoctor.txt')
    ...
    def test_response_1(self):
        ...
        self.assertEqual('Can you think of a specific example ?',el.respond('They re always bugging us about something or other.'))
        self.assertEqual('Your boyfriend made you come here ?',el.respond('Well, my boyfriend made me come here.'))
        self.assertEqual('I am sorry to hear that you are depressed .',el.respond('He says I ''m depressed much of the time.'))
        self.assertEqual('Do you think that coming here will help you not to be unhappy ?',el.respond('It ''s true. I am unhappy.'))
        self.assertEqual('What would it mean to you if you got some help ?',el.respond('I need some help, that much seems certain.'))
        self.assertEqual('Tell me more about your family.',el.respond('Perhaps I could learn to get along with my mother.'))
